...
# Decorator to record method calls and their parameters
    ...
    @record_method_calls
    def run_hashsolo(self, cell_hashing_columns):
        """
        Runs the scanpy.external.pp.hashsolo function on the self.adata object.
        Modifies the self.adata object with the hashed values.

        Args:
            cell_hashing_columns (list): List of column names to be used for cell hashing.
        """
        sc.external.pp.hashsolo(self.adata, cell_hashing_columns)
